...
<div class="container" >  
  ...
  <div class="col-sm-8" id="form2" >    <!-- id="form2-->
    ...
    <h2>MEDICINE DETAILS LIST</h2>
      ...
      <div class="col-xs-3 offset-7" id="form6">
 ...
 <title>
  ...
  ?>
      ...
      <tr>
                ...
                <td>
                  <form method="POST" action="medicine details.php">
                    ...
                    <a href="update/update_medicine.php ? idd=<?php echo $row['medicine_id']; ?>" class="btn btn-primary"> UPDATE</a>
  ...
  <p>
  <a href="medicine details full.php" class="btn btn-primary">FULL PAGE VIEW</a></p>
  </div>
</div>
